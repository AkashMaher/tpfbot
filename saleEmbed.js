...
async function saleEmbed(sale,contract_address) {
const asset = sale[0]
  console.log(asset)
...
// console.log(d)
  ...
  const dataEmbed = {
	color: 0x4df85f,
	title: '',
	description: `[**${asset?.asset?.name} Sold!**](https://opensea.io/assets/ethereum/${contract_address}/${asset?.asset?.token_id})\n
